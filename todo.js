...
var _user$project$Todo$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'ChangeTaskText') {
			var updateTaskText = function (task) {
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					tasks: A2(_elm_lang$core$List$map, updateTaskText, model.tasks)
				});
		} else {
			var updateTaskComplete = function (t) {
				return _elm_lang$core$Native_Utils.eq(t.id, _p0._0.id) ? _elm_lang$core$Native_Utils.update(
					t,
			...
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					tasks: A2(_elm_lang$core$List$map, updateTaskComplete, model.tasks)
				});
		}
	});
		...
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$value(task.text),
						_1: {
							ctor: '::',
					...
					_0: A2(
						...
						},
						{
							...
							_0: _elm_lang$html$Html$text(
								_elm_lang$core$Basics$toString(task.complete)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
